...
// ChatNotificationSettings represents TL type `chatNotificationSettings#56feb816`.
...
const ChatNotificationSettingsTypeID = 0x56feb816
...
func (c *ChatNotificationSettings) Zero() bool {
	...
	if !(c.UseDefaultShowStoryPoster == false) {
		return false
	}
	if !(c.ShowStoryPoster == false) {
		return false
	}
...
func (c *ChatNotificationSettings) TypeInfo() tdp.Type {
	...
	typ.Fields = []tdp.Field{
		...
		{
			Name:       "UseDefaultShowStoryPoster",
			SchemaName: "use_default_show_story_poster",
		},
		{
...
func (c *ChatNotificationSettings) Encode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't encode chatNotificationSettings#56feb816 as nil")
	}
...
func (c *ChatNotificationSettings) EncodeBare(b *bin.Buffer) error {
	...
	b.PutBool(c.UseDefaultShowStoryPoster)
	b.PutBool(c.ShowStoryPoster)
...
func (c *ChatNotificationSettings) Decode(b *bin.Buffer) error {
	if c == nil {
		return fmt.Errorf("can't decode chatNotificationSettings#56feb816 to nil")
	}
	if err := b.ConsumeID(ChatNotificationSettingsTypeID); err != nil {
		return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: %w", err)
	}
...
func (c *ChatNotificationSettings) DecodeBare(b *bin.Buffer) error {
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_mute_for: %w", err)
		}
	...
	}
	{
		value, err := b.Int32()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field mute_for: %w", err)
		}
		c.MuteFor = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_sound: %w", err)
		}
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field sound_id: %w", err)
		}
		c.SoundID = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_show_preview: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field show_preview: %w", err)
		}
		c.ShowPreview = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_mute_stories: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field mute_stories: %w", err)
		}
		c.MuteStories = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_story_sound: %w", err)
		}
	...
	}
	{
		value, err := b.Long()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field story_sound_id: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_show_story_poster: %w", err)
		}
		c.UseDefaultShowStoryPoster = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field show_story_poster: %w", err)
		}
		c.ShowStoryPoster = value
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_disable_pinned_message_notifications: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field disable_pinned_message_notifications: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_disable_mention_notifications: %w", err)
		}
	...
	}
	{
		value, err := b.Bool()
		if err != nil {
			return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field disable_mention_notifications: %w", err)
		}
...
func (c *ChatNotificationSettings) EncodeTDLibJSON(b tdjson.Encoder) error {
	...
	b.PutLong(c.StorySoundID)
	b.Comma()
	b.FieldStart("use_default_show_story_poster")
	b.PutBool(c.UseDefaultShowStoryPoster)
	b.Comma()
...
func (c *ChatNotificationSettings) DecodeTDLibJSON(b tdjson.Decoder) error {
	...
	return b.Obj(func(b tdjson.Decoder, key []byte) error {
		...
		case "story_sound_id":
			...
			c.StorySoundID = value
		case "use_default_show_story_poster":
			value, err := b.Bool()
			if err != nil {
				return fmt.Errorf("unable to decode chatNotificationSettings#56feb816: field use_default_show_story_poster: %w", err)
			}
...
// GetUseDefaultShowStoryPoster returns value of UseDefaultShowStoryPoster field.
func (c *ChatNotificationSettings) GetUseDefaultShowStoryPoster() (value bool) {
	if c == nil {
		return
	}
	return c.UseDefaultShowStoryPoster
}

// GetShowStoryPoster returns value of ShowStoryPoster field.
func (c *ChatNotificationSettings) GetShowStoryPoster() (value bool) {
	if c == nil {
		return
	}
	return c.ShowStoryPoster
}
